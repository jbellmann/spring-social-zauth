...
public abstract class ZAuthAbstractConnection<A> implements Connection<A> {
    ...
    private transient final String monitor = "MONITOR";

    /**
     * Creates a new connection.
     * @param apiAdapter the Service API adapter
     */
    public ZAuthAbstractConnection(ApiAdapter<A> apiAdapter) {
     ...
     * @param apiAdapter the Service API adapter
     */
    public ZAuthAbstractConnection(ConnectionData data, ApiAdapter<A> apiAdapter) {
    ...
    private class ServiceProviderConnectionValuesImpl implements ConnectionValues {
        ...
        public void setDisplayName(String displayName) {
            ZAuthAbstractConnection.this.displayName = displayName;
        }
        
        public void setProfileUrl(String profileUrl) {
            ZAuthAbstractConnection.this.profileUrl = profileUrl;
        }
        
        public void setImageUrl(String imageUrl) {
            ZAuthAbstractConnection.this.imageUrl = imageUrl;
        }
